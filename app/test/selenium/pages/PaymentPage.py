...
class PaymentPage(BasePage):
    ...
    BUTTON_PAY=(By.CSS_SELECTOR,'#accordionBooking div:nth-child(5) .bg-white > div > a')
    BUTTON_PAY_CANCEL = (By.CSS_SELECTOR, '#accordionBooking div:nth-child(4) .bg-white > div > a')
